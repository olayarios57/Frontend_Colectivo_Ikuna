...
export function Footer() {
  return (
    <footer className="py-12 px-6" style={{ backgroundColor: '#1d1d1b', color: 'white' }}>
      <div className="max-w-7xl mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
          ...
          {/* ── Enlaces ── */}
          <div>
            <h4 className="text-lg mb-4" style={{ fontFamily: 'Montserrat, sans-serif', color: '#f18517' }}>
              Enlaces
            </h4>
              ...
              {navLinks.map(({ href, label }) => (
                <li key={label}>
                  <a href={href} target="_blank" rel="noopener noreferrer"
                    className="hover:opacity-70 transition-opacity" style={{ color: 'white' }}>
                    {label}
                  </a>
                </li>
              ))}
