...
const carouselImages = [
  ...
  'https://images.unsplash.com/photo-1757085242669-076c35ff9397?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&q=80&w=1080',
  'https://images.unsplash.com/photo-1764670085300-7951b9132433?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&q=80&w=1080',
  'https://images.unsplash.com/photo-1761618291331-535983ae4296?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&q=80&w=1080',
  'https://images.unsplash.com/photo-1764933361142-fc28a024f3da?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&q=80&w=1080',
            ...
            {highlights.map((highlight, index) => {
              ...
              return (
                <div
                  ...
                  style={{
                    animation: `fadeIn ${2.5 + index * 0.2}s ease-in`,
                    border: '1px solid rgba(241, 133, 24, 0.2)',
                  }}
                >
                  <IconComponent className="mx-auto mb-3" size={32} style={{ color: '#f18517' }} />
                  <h3
